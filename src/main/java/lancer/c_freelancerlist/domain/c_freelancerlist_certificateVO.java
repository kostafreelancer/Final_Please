...
public class c_freelancerlist_certificateVO implements Serializable{
	private int certificate_num;
	private int f_num;
	private String certificate_name;
	private String organization;
	private String accept_date;
	public c_freelancerlist_certificateVO(){}
	public c_freelancerlist_certificateVO(int certificate_num, int f_num, String certificate_name, String organization,
			String accept_date) {
		super();
