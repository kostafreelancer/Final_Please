...
public class c_freelancerlist_school {
	...
	public c_freelancerlist_school(){}
	public c_freelancerlist_school(int school_num, int f_num, String school_name, String major, String school_term,
