	...
	var imgDir = '/resources/e_insertproject_img/'		// directory for images ... e.g. var imgDir="/img/"
    ...
    */
	...
	function init()	{
		if (!ns4)
		{
			...
			sHTML1+="<span id='spanMonth' style='border-width:0;cursor:pointer'	onmouseover='swapImage(\"changeMonth\",\"drop2.png\");window.status=\""+selectMonthMessage+"\"' onmouseout='swapImage(\"changeMonth\",\"drop1.png\");window.status=\"\"' onclick='popUpMonth()'></span>&nbsp;"
			// link to year drop-down list
			sHTML1+="<span id='spanYear' style='border-width:0;cursor:pointer' onmouseover='swapImage(\"changeYear\",\"drop2.png\");window.status=\""+selectYearMessage+"\"' onmouseout='swapImage(\"changeYear\",\"drop1.png\");window.status=\"\"' onclick='popUpYear()'></span>&nbsp;"
	...
	function constructMonth() {
		...
		if (!monthConstructed) {
			...
			document.getElementById("selectMonth").innerHTML = "<table width=100 style='font-family:arial; font-size:11px; border-width:1; border-style:solid; border-color:#a0a0a0;' bgcolor='white' cellspacing=0 onmouseover='clearTimeout(timeoutID1)'	onmouseout='clearTimeout(timeoutID1);timeoutID1=setTimeout(\"popDownMonth()\",100);event.cancelBubble=true'>" +	sHTML +	"</table>"
