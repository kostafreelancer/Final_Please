...
<body>
	...
	<span class="txt">인증번호가 발송되었습니다. 인증번호를 입력해주세요.</span><br>
	<input id="num" name="num" type="text"> <span id="Timer"></span>
	<input id="refresh" name="email_agian" type="button" onclick="location.href='/verification/emailVerification'" value="재전송"><br>
