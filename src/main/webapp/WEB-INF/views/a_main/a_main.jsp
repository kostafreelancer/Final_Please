...
<link rel="stylesheet" href="/resources/a_main_css/a_main.css" type="text/css"
	media="screen" />
...
<%@include file="../c_common/header_enterprise.jsp"%>
	...
	<section>
	<div class="a_main_top">
		<h3>회원정보 입력</h3>
	</div>


<form action="/e_mypage/a_main" method="post" name="EnterpriseWriteFm">
	<div class="a_main_table1">
		<h4>아이디 및 비밀번호</h4>
